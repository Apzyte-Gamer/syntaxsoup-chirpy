...
You can join the Discord community (with more writeups!) [here](https://discord.com/invite/Un7avdkq7Z).
...
We can see in the storage URL that its inside the `/src/index.html` file directory, what if we go to the root directory?
...
## Miscellaneous/Out of the Bucket 2
Created by: `windex`
...
After browsing many many directories, poking down never ending rabbit holes of `C:\Windows\Prefetch` (which was very interesting) and many more places, I found `C:\Users\analyst\AppData\Local\Microsoft\Windows\History`.
...
## Reverse Engineering/All Worbled Up

...
I participated in the BackdoorCTF 2024 solo, and surpassed my expectations majorly. The following is a writeup/walkthrough of how each flag was grabbed and the thought process for each.

You can join the Discord community (with more writeups!) [here](https://discord.gg/W5ZgAmBgjP).

## Web Exploitation/What's My Password? (? solves)
Created by: `User`
...
## Open-Source Intelligence/Czech Where? (? solves)
Created by: `Lychi`
...
## Open-Source Intelligence/Away on Vacation (? solves)
Created by: `Lychi`
...
## Open-Source Intelligence/Personal Breach (? solves)
Created by: `Lychi`
...
## Open-Source Intelligence/A Harsh Reality of Passwords (? solves)
Created by: `Lychi`
...
## Networks/Copper Selachimorpha (? solves)
Created by: `skat`
...
## Forensics/skat's SD card (? solves)
Created by: `skat`
...
## Networks/skat's Network History (? solves)
Created by: `skat`
...
## Forensics/Not Just Media (? solves)
Created by: `rph`
...
## Forensics/Corrupted World (? solves)
Created by: `rph`
